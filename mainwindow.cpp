...
MainWindow::MainWindow(QWidget *parent):QMainWindow(parent), ui(new Ui::MainWindow){
    ...
    connect(ui->squareButton, SIGNAL(released()), this, SLOT(sqaureRootOperation()));
...
void MainWindow::displayEquation(){
    ...
    if((ui->squareButton->isChecked()) && (!secondNumberPressed2)){
        calculatorTextNumber = pressedButton->text().toDouble();
        newCalculatorText = QString::number(firstNumber, 'g', 15);
        ui->equationText->setText(newCalculatorText + " + ");
    }

    if((ui->squareRootButton->isChecked()) && (!secondNumberPressed2)){
        calculatorTextNumber = pressedButton->text().toDouble();
        newCalculatorText = QString::number(firstNumber, 'g', 15);
        ui->equationText->setText(newCalculatorText + " - ");
    }
    ...
    if((ui->factorialButton->isChecked()) && (!secondNumberPressed2)){
        calculatorTextNumber = pressedButton->text().toDouble();
        newCalculatorText = QString::number(firstNumber, 'g', 15);
        ui->equationText->setText(newCalculatorText + " / ");
    }
